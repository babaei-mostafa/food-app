  ...
  return (
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="relative">
        {/* overlay */}
        <div className="absolute h-full w-full top-0 left-0 bg-black/50 rounded-xl text-white">
          <p className="text-2xl font-bold px-2 pt-4">Sun's out, BOGO's out</p>
          <p className="px-2">Through 8/26</p>
          <button className="absolute bottom-4 mx-2 border-white bg-white text-black cursor-pointer">
            Order Now
          </button>
        </div>
        <img
